...
const Home = () => {
  return (
    <div name='home' className="w-full md:h-screen bg-gradient-to-b from-black via-black to-gray-500">
      <div className="max-w-screen-lg h-full mx-auto p-4 pt-24 md:pt-44 flex">
...
Indore, Madhya Pradesh. My interests range from back-side, front-end, system management to mobile applications. As you can see, I am interested in all parts of application development.</p>
          <Link to="portfolio" smooth duration={1000} className="group p-2 mt-6 bg-gradient-to-r from-cyan-500 to-blue-800 text-white cursor-pointer rounded-lg w-[65%] md:w-[35%] text-lg flex items-center justify-center">
           Portfolio 
